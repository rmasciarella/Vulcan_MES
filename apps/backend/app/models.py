...
class User(UserBase, table=True):
    ...
    mfa_setup_at: datetime | None = Field(default=None)
    mfa_enabled_at: datetime | None = Field(default=None)
    mfa_disabled_at: datetime | None = Field(default=None)
    last_mfa_verification: datetime | None = Field(default=None)
    backup_codes_generated_at: datetime | None = Field(default=None)
