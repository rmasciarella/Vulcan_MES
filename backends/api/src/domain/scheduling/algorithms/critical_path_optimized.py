...
# Local no-op observability hooks to keep domain independent
...
def monitor_performance(_label: str):  # type: ignore
    def _decorator(func):
        return func
    return _decorator

# Domain layer must not depend on infrastructure cache; provide None placeholder
scheduling_cache = None  # type: ignore
